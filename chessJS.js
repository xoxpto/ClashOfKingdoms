window.onload = ()=>{
    ...
    //objetos para as peças de xadrez//Skins
    var chessPieces ={
        'p':'&#9817;',	
        'r':'&#9820;',
        'b':'&#9821;',
    ...
    //função que atualiza as peças em jogo 
    ...
    function updateSquareColor(){
        ...
        for(i=0; i<64; ++i){
            ...
            //para linhas numero impar         
            else{
                //para colunas numeros impar
                if(i%2!=0){
                    square[i].style.backgroundColor = "rgb(36, 127, 16)";          
                    square[i].style.boxShadow ="none";
                    square[i].style.borderColor = "rgb(36, 127, 16)";
                }
                //para colunas numeros par
                else{
                    square[i].style.backgroundColor = "rgb(207, 245, 151)";             
                    square[i].style.boxShadow ="none";                                  
                    square[i].style.borderColor = "rgb(207, 245, 151)";
    ...
    //funcao que atualiza as cores das peças para diferenciar as cores das peças
    ...
    //Funcão que atualiza os movimentos do jogador por cor
    ...
    //Função que atualiza as scopes das cores das peças
    ...
    //inicializar nome de utilizador
    ...
    //funcao que atualiza os pontos do utilizador
    ...
    //Função que atualiza as peças mortas por cor dos quadrados
    ...
    // funcao que atualiza as peças brancas mortas
    ...
    // funcao que atualiza as peças pretas mortas
    ...
    //funcao para verificar as scopes das peças pretas
    function checkBlackScopes(n,piecesPos){
        x = n;
        var piece = piecesPos[n];
        returnScopes = [];
        
        //-----scopes do peão preto-----
        if(piece=="s"){
        x -=8;
    ...
    //funcao para ver as scopes das peças brancas
    ...
    //funcão de executar check em todos os quadrados de click 
    function check(){
        //if its my turn
        if(turn){
            ...
            //if clicked piece is movable         
                ...
                if(scopesString.indexOf (String (sqNum))>=0){
                    ...
                    if(!saveBlackKing){           
                        ...
                        startWhiteTimer();
                        scopes = [];  
                        //check se rei branco esta checkmated
                        ...
                        turn = false;
                        //SO exucutar se estiver em mode singleplayer
                        if(singlePlayer){
